...
public class ComentariosTest {
	...
	public static void main(String[] args) {
		...
		ContoDAO contoDAO = new ContoDAO(em);
		ComentariosController controller = new ComentariosController(dao, contoDAO);
		...
		switch(opcao) {
			...
			case 1: 
				...
				System.out.println("Informe o id do conto");
				Integer id_conto = Integer.parseInt(sc.nextLine());
				
				
				controller.salva(autor, mensagem, id_conto);
				break;
